...
namespace KnownEntities {
	...
	*/
	...
	static map_type entities = boost::assign::map_list_of
		...
		(9, "Arrow Trap (Right-Facing)")
		(9 | ARROW_TRAP_LEFT_FACING, "Arrow Trap (Left-Facing)")
		(22, "Tiki Trap")
		...
		(40, "Idol Falling Trap Block")
		(46, "Gravestone")
		(86, "Wooden Block")
		(9097, "Jungle Terrain Block")
		(76, "Beehive Block")
		(9095, "Temple/Castle Block")
		(74, "Hell Brick Block")
		...
		//uninteractable foreground
		(3004, "Cash Register")
		(83, "Temple Foreground Obstruction")
		(7, "Dirt Patch")
		(26, "Bedrock Edge Patch")
		(30, "Jungle Dirt Patch")
		(31, "Temple Block Patch")
		(48, "Worm Terrain Patch")
		(50, "Mines Terrain Patch") 
		(51, "Ice Caves Terrain Patch")
		(71, "Golden City Terrain Patch")
		(72, "Hell Terrain Patch")
		(78, "Beehive Patch")
		(88, "Wooden Patch")
		(89, "Stone Patch")
		(90, "Vertical Patch")
		(98, "Hell Terrain Patch (Thin)")
		(99, "Broken Fence Patch");
